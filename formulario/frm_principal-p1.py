...
class Ui_frm_principal(object):
    def setupUi(self, frm_principal):
        ...
        self.btn_maximize_rest.setVisible(False)
        self.btn_maximize_rest.setFocusPolicy(Qt.NoFocus)
        ...
        font.setBold(True)
        font.setWeight(75)
        self.btn_relatorio_cadastros.setFont(font)
        ...
        self.btn_relatorio_cadastros.setStyleSheet(u"QPushButton{\n"
                                                   ...
                                                   "}")
        icon6 = QIcon()
        icon6.addFile(u"./imagens/relatorio-cadastros-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_relatorio_cadastros.setIcon(icon6)
        ...
        self.btn_relatorio_caixa.setFont(font)
        ...
        self.btn_relatorio_caixa.setStyleSheet(u"QPushButton{\n"
                                               ...
                                               "}")
        icon7 = QIcon()
        icon7.addFile(u"./imagens/relatorio-caixa-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_relatorio_caixa.setIcon(icon7)
        ...
        self.btn_relatorio_pesos.setFont(font)
        ...
        self.btn_relatorio_pesos.setStyleSheet(u"QPushButton{\n"
                                               ...
                                               "}")
        icon8 = QIcon()
        icon8.addFile(u"./imagens/relatorio-pesos-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_relatorio_pesos.setIcon(icon8)
        ...
        self.grl_menu.addWidget(self.fra_submenu_relatorio, 6, 0, 1, 1)
        ...
        self.btn_cadastro.setStyleSheet(u"QPushButton{\n"
                                        ...
                                        "}")
        icon9 = QIcon()
        icon9.addFile(u"./imagens/caixa_pasta.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastro.setIcon(icon9)
        self.btn_cadastro.setIconSize(QSize(30, 30))
        self.btn_cadastro.setFlat(True)

        self.grl_menu.addWidget(self.btn_cadastro, 1, 0, 1, 1)
        ...
        self.btn_movimento.setFont(font1)
        ...
        self.btn_movimento.setStyleSheet(u"QPushButton{\n"
                                         ...
                                         "}")
        icon10 = QIcon()
        icon10.addFile(u"./imagens/movimento-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_movimento.setIcon(icon10)
        self.btn_movimento.setIconSize(QSize(30, 30))
        self.btn_movimento.setFlat(True)

        self.grl_menu.addWidget(self.btn_movimento, 3, 0, 1, 1)
        ...
        self.btn_relatorio.setFont(font1)
        ...
        self.btn_cadastro_empresa.setFont(font)
        ...
        self.btn_cadastro_empresa.setStyleSheet(u"QPushButton{\n"
                                                ...
                                                "}")
        icon12 = QIcon()
        icon12.addFile(u"./imagens/empresa-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastro_empresa.setIcon(icon12)
        ...
        self.btn_cadastro_cliente.setStyleSheet(u"QPushButton{\n"
                                                ...
                                                "}")
        icon13 = QIcon()
        icon13.addFile(u"./imagens/cliente-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastro_cliente.setIcon(icon13)
        ...
        self.btn_cadastro_fornecedor.setFont(font)
        ...
        self.btn_cadastro_fornecedor.setStyleSheet(u"QPushButton{\n"
                                                   ...
                                                   "}")
        icon14 = QIcon()
        icon14.addFile(u"./imagens/fornecedor-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastro_fornecedor.setIcon(icon14)
        ...
        self.btn_cadastro_transportadora.setFont(font)
        ...
        self.btn_cadastro_transportadora.setStyleSheet(u"QPushButton{\n"
                                                       ...
                                                       "}")
        icon15 = QIcon()
        icon15.addFile(u"./imagens/transportadora-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastro_transportadora.setIcon(icon15)
        ...
        self.btn_cadastro_motorista.setFont(font)
        ...
        self.btn_cadastro_motorista.setStyleSheet(u"QPushButton{\n"
                                                  ...
                                                  "}")
        icon16 = QIcon()
        icon16.addFile(u"./imagens/motorista-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastro_motorista.setIcon(icon16)
        ...
        self.btn_cadastro_veiculo.setFont(font)
        ...
        self.btn_cadastro_veiculo.setStyleSheet(u"QPushButton{\n"
                                                ...
                                                "}")
        icon17 = QIcon()
        icon17.addFile(u"./imagens/veiculo-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastro_veiculo.setIcon(icon17)
        ...
        self.btn_cadastro_usuario.setStyleSheet(u"QPushButton{\n"
                                                ...
                                                "}")
        icon18 = QIcon()
        icon18.addFile(u"./imagens/usuario-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastro_usuario.setIcon(icon18)
        ...
        self.btn_cadastro_permissao.setFont(font)
        ...
        self.btn_cadastro_permissao.setStyleSheet(u"QPushButton{\n"
                                                  ...
                                                  "}")
        icon19 = QIcon()
        icon19.addFile(u"./imagens/usuario_cadeado-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_cadastro_permissao.setIcon(icon19)
        ...
        self.grl_menu.addWidget(self.fra_submenu_cadastro, 2, 0, 1, 1)
        ...
        self.btn_sobre.setStyleSheet(u"QPushButton{\n"
                                     ...
                                     "}")
        icon20 = QIcon()
        icon20.addFile(u"./imagens/informacoes-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_sobre.setIcon(icon20)
        self.btn_sobre.setIconSize(QSize(30, 30))
        self.btn_sobre.setFlat(True)

        self.grl_menu.addWidget(self.btn_sobre, 9, 0, 1, 1)
        ...
        self.btn_configuracao_balanca.setFont(font)
        ...
        self.btn_configuracao_balanca.setStyleSheet(u"QPushButton{\n"
                                                    ...
                                                    "}")
        icon21 = QIcon()
        icon21.addFile(u"./imagens/balanca-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_configuracao_balanca.setIcon(icon21)
        ...
        self.btn_configuracao_sistema.setFont(font)
        ...
        self.btn_configuracao_sistema.setStyleSheet(u"QPushButton{\n"
                                                    ...
                                                    "}")
        icon22 = QIcon()
        icon22.addFile(u"./imagens/configuracao-sistema-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_configuracao_sistema.setIcon(icon22)
        ...
        self.grl_menu.addWidget(self.fra_submenu_configuracao, 8, 0, 1, 1)
        ...
        self.btn_sobre_informacoes.setFont(font)
        ...
        self.btn_sobre_informacoes.setStyleSheet(u"QPushButton{\n"
                                                 ...
                                                 "	background: rgba(31,31,31,.2);\n"
                                                 "}\n"
                                                 "QPushButton#btn_sobre_informacoes:disabled {\n"
                                                 "	border: 1px solid rgba(166,166,166,1);\n"
                                                 "	color: #6a6767;"
                                                 "}")
        icon23 = QIcon()
        icon23.addFile(u"./imagens/informacao-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_sobre_informacoes.setIcon(icon23)
        ...
        self.grl_menu.addWidget(self.fra_submenu_sobre, 10, 0, 1, 1)
        ...
        self.btn_configuracao.setFont(font1)
        ...
        self.btn_configuracao.setStyleSheet(u"QPushButton{\n"
                                            ...
                                            "}")
        icon24 = QIcon()
        icon24.addFile(u"./imagens/configuracao-vector.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_configuracao.setIcon(icon24)
        self.btn_configuracao.setIconSize(QSize(30, 30))
        self.btn_configuracao.setFlat(True)

        self.grl_menu.addWidget(self.btn_configuracao, 7, 0, 1, 1)
        ...
        self.btn_movimento_pesar.setFont(font)
        ...
        self.btn_movimento_caixa.setFont(font)
        ...
        self.grl_menu.addWidget(self.fra_submenu_movimento, 4, 0, 1, 1)
        ...
        #self.vsb_menu.setWidgetResizable(True)
        #self.vsb_menu.setVisible(False)

        #self.grl_menu.addWidget(self.vsb_menu, 1, 1, 10, 1)
